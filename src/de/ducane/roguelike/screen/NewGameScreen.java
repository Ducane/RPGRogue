...
public class NewGameScreen extends Screen
{
	...
	{
		game.gsm.crossfadeSwitch( new PlayScreen( game, 48f, name.toString() ), ColorCrossfade.BLACK, 1f );
	}
	...
	public void onResized( final int width, final int height )
	{
		...
		buttonBounds = new Rectangle2D.Float( (int) ( 0.85f * getWidth() ), (int) ( 0.9f * getHeight() ) - ( fm.getAscent() - fm.getLeading() ), fm.stringWidth( "OK" ), fm.getAscent() - fm.getLeading() );
	}
	...
	public void render( final Graphics2D g )
	{
		...
		g.drawString( "Benenne deinen Helden!:", (int) ( 0.05f * getWidth() ), fm.getAscent() + (int) ( 0.1f * getHeight() ) );
		
		g.setColor( buttonSelection ? Color.YELLOW : Color.WHITE );
		// g.drawRect( (int) button_bounds.getX(), (int) button_bounds.getY(), (int) button_bounds.getWidth(), (int) button_bounds.getHeight() );
		g.drawString( "OK", (int) buttonBounds.getX(), (int) ( buttonBounds.getY() + ( buttonBounds.getHeight() - fm.getAscent() - fm.getLeading() ) / 2 + fm.getAscent() ) );
